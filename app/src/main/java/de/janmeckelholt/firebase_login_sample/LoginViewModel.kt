...
class LoginViewModel : ViewModel() {
    ...
    fun getFactToDisplay(context: Context): String {
        ...
        return when(funFactType ) {
            context.getString(R.string.fact_type_android) -> androidFacts[Random.nextInt(0, androidFacts.size)]
            context.getString(R.string.fact_type_california) -> californiaFacts[Random.nextInt(0, californiaFacts.size)]
            else -> "Sorry no fun fact for you"
        }
    }
}
